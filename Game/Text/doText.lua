...
for i,v in ipairs(processText) do
	if i <= 3 then
		...
		queue("SelSpaa",lowerSelÁ)
		queue("SelSpai",lowerSelÍ)
		queue("SelSpau",lowerSelÚ)
		queue("SelSpae",lowerSelÉ)
		queue("SelSpao",lowerSelÓ)
		queue("SelSpan",lowerSelÑ)
		...
		queue("SelSpaA",upperSelÁ)
		queue("SelSpaI",upperSelÍ)
		queue("SelSpaU",upperSelÚ)
		queue("SelSpaE",upperSelÉ)
		queue("SelSpaO",upperSelÓ)
		queue("SelSpaN",upperSelÑ)
		queue(" ",space)
		queue("Sel ",space)
	end
end
